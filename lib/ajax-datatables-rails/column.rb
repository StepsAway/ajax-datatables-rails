module AjaxDatatablesRails
  ...
  class EnumColumn < Column
    ...
    def order_condition(direction)
      ...
      ordered_values, direction = case direction
        when :asc then [ascending_values, direction]
        when :desc then [ascending_values.reverse, direction]
      ...
      order_sql = ordered_values.each_with_index.reduce('CASE ') do |sql, (value, order)|
